...
if(isset($_POST['search'])) {
    ...
    // Search query modified for customer table
    $sql = "SELECT id, f_name, l_name, address, job FROM customer WHERE id = ?";
...
echo "<h1>Customer Search Results</h1>";
...
echo "<h2>Search for a Customer</h2>";
