...
if(isset($_POST['search'])) {
    ...
    // Search query modified for manufacture table
    $sql = "SELECT name, type, city, country FROM manufacture WHERE name LIKE ?";
...
echo "<h1>Manufacture Search Results</h1>";
...
echo "<h2>Search for a Manufacture</h2>";
echo "<form method='post' action='" . $_SERVER['PHP_SELF'] . "'>";
echo "<input type='hidden' name='search' value='1'>";
echo "<label for='search_term'>Search Name:</label><input type='text' name='search_term' required><br>";
